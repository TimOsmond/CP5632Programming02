...
def convert_phrase_to_sentence(phrase):
    """
    >>> convert_phrase_to_sentence("hello") == "Hello."
    True
    >>> convert_phrase_to_sentence("It is an ex parrot.") == "It is an ex parrot."
    True
    >>> convert_phrase_to_sentence("it's nearly Christmas") == "It's nearly Christmas."
    True
    """
    if phrase[-1] == ".":
        period = ""
        ...
        period = "."
    sentence = phrase[0].upper() + phrase[1:] + period
    return sentence
